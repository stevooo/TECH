...
while($z = pg_fetch_array($perres)){
	...
	if($mobiletablet == 't'){
		...
		$resmota = pg_query($conn,$sqlmota);
                echo "<br><a href='categorypage.php?category={mobileTablet}&name=Mobile/Tablet'><h1 class='recent'>Mobile/Tablet</h1></a>";
		echo "<ul id='scroller2'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$b['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($business == 't'){
		...
		echo "<ul id='scroller3'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$c['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($hardware == 't'){
		...
		$resha = pg_query($conn,$sqlha);
                echo "<br><a href='categorypage.php?category={hardware}&name=Hardware'><h1 class='recent'>Hardware</h1></a>";
		echo "<ul id='scroller4'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$d['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($software == 't'){
		...
		$resso = pg_query($conn,$sqlso);
                echo "<br><a href='categorypage.php?category={software}&name=Software'><h1 class='recent'>Software</h1></a>";
		...
		echo "<ul id='scroller5'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$e['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($wearables == 't'){
		...
		$reswe = pg_query($conn,$sqlwe);
                echo "<br><a href='categorypage.php?category={wearables}&name=Wearables'><h1 class='recent'>Wearables</h1></a>";
		echo "<ul id='scroller6'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$f['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($tvs == 't'){
		...
		$restvs = pg_query($conn,$sqltvs);
                echo "<br><a href='categorypage.php?category={tvs}&name=TV'><h1 class='recent'>TV</h1><a>";
	...
	if($gaming == 't'){
		...
		$resgam = pg_query($conn,$sqlgam);
                echo "<br><a href='categorypage.php?category={gaming}&name=Gaming'><h1 class='recent'>Gaming</h1></a>";
		echo "<ul id='scroller8'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$h['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
	if($socialmedia == 't'){
		...
		$ressm = pg_query($conn,$sqlsm);
                echo "<br><a href='categorypage.php?category={socialMedia}&name=Social Media'><h1 class='recent'>Social Media</h1></a>";
		echo "<ul id='scroller9'>";
			...
			echo "<h2><a class='headline' href='http://users.aber.ac.uk/stm26/TECH/story.php?storyID=".$i['storyid']."'>".$headline5."</a></h2>";
			echo "</section></li>";
		}echo "</ul>";
	}
?>

...
<html lang="en">
    ...
    <body>
        ...
        <section class="content">
            ...
            $categorysql = "SELECT DISTINCT * FROM stories ORDER BY views DESC LIMIT $limit";
          ...
          <img class='cstoryimg' id='" . $d['storyid'] . "' src='" . $image2 . "'/></a>";
            ...
            <?php
                ...
                echo"<form method='post' action='http://users.aber.ac.uk/stm26/TECH/popular.php?limit=$limit' name='comment'>
